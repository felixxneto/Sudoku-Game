...
```bash
git clone https://github.com/felixxneto/Sudoku-Game.git
cd Sudoku-Game
```
...
```bash
java -jar sudoku-ui/target/sudoku-ui.jar
```

### 5. Rode a versão console
```bash
java -jar sudoku-console/target/sudoku-console.jar
```
...
1. Clique em uma célula vazia e digite um número de 1 a 9
2. Use **Verificar jogo** para checar erros a qualquer momento
3. Use **Reiniciar Jogo** para começar do zero
4. Quando terminar, clique em **Concluir jogo**
...
Feito por **Felix** — [GitHub](https://github.com/felixxneto)
